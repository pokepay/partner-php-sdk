...
class CreateCoupon extends TestCase
{
    public function testCreateCoupon0()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            "2020-11-12T13:23:29.000000Z",
            "2023-03-20T03:52:41.000000Z",
    ...
    public function testCreateCoupon8()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                'discount_amount' => 137,
                'display_ends_at' => "2023-09-17T07:12:51.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => FALSE,
                'is_public' => FALSE,
                'code' => "VeBxFuF7c",
    ...
    public function testCreateCoupon9()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2021-02-10T19:41:27.000000Z",
                'display_ends_at' => "2020-04-30T08:33:22.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => FALSE,
                'is_public' => TRUE,
                'code' => "d",
    ...
    public function testCreateCoupon10()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2020-07-15T16:26:09.000000Z",
                'display_ends_at' => "2020-10-01T04:09:48.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "sGmF",
    ...
    public function testCreateCoupon11()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2020-10-26T05:23:57.000000Z",
                'display_ends_at' => "2020-12-24T01:48:56.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "tV",
    ...
    public function testCreateCoupon20()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_ends_at' => "2023-10-23T16:51:41.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "SlKK1O1",
    ...
    public function testCreateCoupon21()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2020-11-07T10:25:39.000000Z",
                'display_ends_at' => "2021-08-06T15:25:36.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "1Zki",
    ...
    public function testCreateCoupon22()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2021-07-28T01:35:32.000000Z",
                'display_ends_at' => "2020-07-09T23:12:58.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => FALSE,
                'is_public' => TRUE,
                'code' => "yp1GcS4N",
    ...
    public function testCreateCoupon23()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2020-05-08T14:45:55.000000Z",
                'display_ends_at' => "2023-04-16T11:22:24.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => TRUE,
                'is_public' => TRUE,
                'code' => "W",
    ...
    public function testCreateCoupon32()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_ends_at' => "2021-08-06T21:48:06.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => FALSE,
                'is_public' => TRUE,
                'code' => "7e4a",
    ...
    public function testCreateCoupon33()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2023-11-10T02:55:13.000000Z",
                'display_ends_at' => "2021-11-26T19:22:27.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => FALSE,
                'is_public' => FALSE,
                'code' => "zqZ6lGrz",
    ...
    public function testCreateCoupon34()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2023-01-23T09:06:34.000000Z",
                'display_ends_at' => "2021-02-23T09:01:35.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => FALSE,
                'is_public' => TRUE,
                'code' => "x4AXM",
    ...
    public function testCreateCoupon35()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2023-06-28T00:35:01.000000Z",
                'display_ends_at' => "2021-01-08T03:29:11.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => TRUE,
                'is_public' => TRUE,
                'code' => "M328xFuB",
    ...
    public function testCreateCoupon44()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_ends_at' => "2022-03-23T18:12:45.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "4",
    ...
    public function testCreateCoupon45()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2021-07-06T15:27:25.000000Z",
                'display_ends_at' => "2023-03-15T07:30:18.000000Z",
                'is_disabled' => TRUE,
                'is_hidden' => FALSE,
                'is_public' => TRUE,
                'code' => "uJCfB",
    ...
    public function testCreateCoupon46()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2020-04-24T16:30:28.000000Z",
                'display_ends_at' => "2022-05-10T00:35:44.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => TRUE,
                'is_public' => FALSE,
                'code' => "Gd5KFM",
    ...
    public function testCreateCoupon47()
    {
        ...
        $request = new Request\CreateCoupon(
            ...
            [
                ...
                'display_starts_at' => "2022-10-17T13:00:29.000000Z",
                'display_ends_at' => "2023-05-30T16:53:50.000000Z",
                'is_disabled' => FALSE,
                'is_hidden' => TRUE,
                'is_public' => TRUE,
                'code' => "sk",
