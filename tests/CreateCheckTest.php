...
class CreateCheck extends TestCase
{
    ...
    public function testCreateCheck4()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'money_amount' => 2007.0,
                'expires_at' => "2021-12-19T15:34:12.000000+09:00",
                'usage_limit' => 5825,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck5()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'money_amount' => 9899.0,
                'point_expires_at' => "2020-04-03T06:29:11.000000+09:00",
                'expires_at' => "2020-05-25T23:00:02.000000+09:00",
                'usage_limit' => 9349,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck6()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2020-05-12T00:06:28.000000+09:00",
                'expires_at' => "2022-05-05T21:50:12.000000+09:00",
                'usage_limit' => 8579,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck7()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2023-05-16T00:55:10.000000+09:00",
                'expires_at' => "2020-12-01T21:23:00.000000+09:00",
                'usage_limit' => 9921,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck12()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'money_amount' => 3538.0,
                'point_amount' => 2009.0,
                'expires_at' => "2020-08-28T12:34:03.000000+09:00",
                'usage_limit' => 1440,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck13()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'money_amount' => 6236.0,
                'point_amount' => 1020.0,
                'point_expires_at' => "2020-09-17T12:01:30.000000+09:00",
                'expires_at' => "2020-01-30T22:41:27.000000+09:00",
                'usage_limit' => 7068,
                'is_onetime' => TRUE,
    ...
    public function testCreateCheck14()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2023-02-11T10:04:11.000000+09:00",
                'expires_at' => "2020-12-27T09:38:55.000000+09:00",
                'usage_limit' => 7632,
                'is_onetime' => TRUE,
    ...
    public function testCreateCheck15()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2020-04-19T07:27:53.000000+09:00",
                'expires_at' => "2021-12-09T19:50:18.000000+09:00",
                'usage_limit' => 7090,
                'is_onetime' => TRUE,
    ...
    public function testCreateCheck20()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'point_amount' => 7433.0,
                'expires_at' => "2020-06-17T18:36:18.000000+09:00",
                'usage_limit' => 2878,
                'is_onetime' => TRUE,
    ...
    public function testCreateCheck21()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                'point_amount' => 1619.0,
                'point_expires_at' => "2020-09-11T11:17:54.000000+09:00",
                'expires_at' => "2021-12-08T07:48:33.000000+09:00",
                'usage_limit' => 6198,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck22()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2023-10-13T14:03:50.000000+09:00",
                'expires_at' => "2021-09-30T14:14:20.000000+09:00",
                'usage_limit' => 6565,
                'is_onetime' => FALSE,
    ...
    public function testCreateCheck23()
    {
        ...
        $request = new Request\CreateCheck(
            ...
            [
                ...
                'point_expires_at' => "2023-09-04T23:43:12.000000+09:00",
                'expires_at' => "2022-06-02T14:38:33.000000+09:00",
                'usage_limit' => 2491,
                'is_onetime' => FALSE,
