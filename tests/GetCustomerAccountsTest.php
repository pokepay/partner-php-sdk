...
class GetCustomerAccounts extends TestCase
{
    ...
    public function testGetCustomerAccounts6()
    {
        ...
        $request = new Request\GetCustomerAccounts(
            "cc3e9a8d-9f53-49c0-aae4-655b6560b2b8",
            [
                'created_at_to' => "2023-07-09T23:41:16.000000+09:00",
                'is_suspended' => TRUE,
                'status' => "pre-closed",
    ...
    public function testGetCustomerAccounts7()
    {
        ...
        $request = new Request\GetCustomerAccounts(
            "cc3e9a8d-9f53-49c0-aae4-655b6560b2b8",
            [
                'created_at_from' => "2022-11-11T13:33:04.000000+09:00",
                'created_at_to' => "2022-11-13T10:13:32.000000+09:00",
                'is_suspended' => FALSE,
                'status' => "pre-closed",
    ...
    public function testGetCustomerAccounts8()
    {
        ...
        $request = new Request\GetCustomerAccounts(
            ...
            [
                'per_page' => 290,
                'created_at_from' => "2023-12-29T01:09:34.000000+09:00",
                'created_at_to' => "2024-03-15T02:26:12.000000+09:00",
                'is_suspended' => FALSE,
                'status' => "suspended",
                'external_id' => "87oiAkJ",
                'tel' => "06-68637053",
    ...
    public function testGetCustomerAccounts9()
    {
        ...
        $request = new Request\GetCustomerAccounts(
            ...
            [
                'page' => 9338,
                'per_page' => 2970,
                'created_at_from' => "2022-10-23T14:46:45.000000+09:00",
                'created_at_to' => "2024-06-14T14:05:22.000000+09:00",
                'is_suspended' => TRUE,
                'status' => "suspended",
