...
$request = new Request\ListCoupons(
    ...
    [
        ...
        'available_from' => "2024-01-01T12:44:54.000000+09:00", // 利用可能期間 (開始日時)
        'available_to' => "2024-07-31T12:27:29.000000+09:00", // 利用可能期間 (終了日時)
        'page' => 1,                              // ページ番号
...
$request = new Request\CreateCoupon(
    ...
    "2020-07-15T08:57:47.000000+09:00",
    "2022-01-07T23:37:09.000000+09:00",
    ...
    [
        ...
        'display_starts_at' => "2023-08-15T08:13:29.000000+09:00", // クーポンの掲載期間(開始日時)
        'display_ends_at' => "2020-08-22T11:38:16.000000+09:00", // クーポンの掲載期間(終了日時)
...
$request = new Request\UpdateCoupon(
    ...
    [
        ...
        'starts_at' => "2023-07-21T21:02:22.000000+09:00",
        'ends_at' => "2021-09-25T18:34:59.000000+09:00",
        'display_starts_at' => "2022-01-28T11:32:22.000000+09:00", // クーポンの掲載期間(開始日時)
        'display_ends_at' => "2021-11-07T08:47:51.000000+09:00", // クーポンの掲載期間(終了日時)
