...
$request = new Request\ListChecks(
    [
        ...
        'organization_code' => "f0lb",            // 組織コード
        'expires_from' => "2020-03-28T15:31:15.000000+09:00", // 有効期限の期間によるフィルター(開始時点)
        'expires_to' => "2024-10-02T14:15:26.000000+09:00", // 有効期限の期間によるフィルター(終了時点)
        'created_from' => "2021-03-15T05:13:37.000000+09:00", // 作成日時の期間によるフィルター(開始時点)
        'created_to' => "2020-05-19T16:46:43.000000+09:00", // 作成日時の期間によるフィルター(終了時点)
        'issuer_shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 発行店舗ID
        'description' => "STgo",                  // チャージQRコードの説明文
...
$request = new Request\CreateCheck(
    ...
    [
        'money_amount' => 414.0,                  // 付与マネー額
        'point_amount' => 6146.0,                 // 付与ポイント額
        'description' => "test check",            // 説明文(アプリ上で取引の説明文として表示される)
        'is_onetime' => TRUE,                     // ワンタイムかどうかのフラグ
        'usage_limit' => 9182,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2020-08-07T10:56:40.000000+09:00", // チャージQRコード自体の失効日時
        'point_expires_at' => "2025-02-21T19:12:29.000000+09:00", // チャージQRコードによって付与されるポイント残高の有効期限
...
$request = new Request\UpdateCheck(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // checkId: チャージQRコードのID
    [
        'money_amount' => 2683.0,                 // 付与マネー額
        'point_amount' => 8755.0,                 // 付与ポイント額
        'description' => "test check",            // チャージQRコードの説明文
        'is_onetime' => FALSE,                    // ワンタイムかどうかのフラグ
        'usage_limit' => 7137,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2024-04-18T11:16:34.000000+09:00", // チャージQRコード自体の失効日時
        'point_expires_at' => "2025-06-06T17:44:14.000000+09:00", // チャージQRコードによって付与されるポイント残高の有効期限
        'point_expires_in_days' => 60,            // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
        'bear_point_account' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // ポイント額を負担する店舗のウォレットID
