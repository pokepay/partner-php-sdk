...
$request = new Request\ListChecks(
    [
        ...
        'organization_code' => "DazAf",           // 組織コード
        'expires_from' => "2023-04-20T00:53:32.000000Z", // 有効期限の期間によるフィルター(開始時点)
        'expires_to' => "2023-12-03T18:01:03.000000Z", // 有効期限の期間によるフィルター(終了時点)
        'created_from' => "2022-01-26T00:25:32.000000Z", // 作成日時の期間によるフィルター(開始時点)
        'created_to' => "2020-09-07T00:32:24.000000Z", // 作成日時の期間によるフィルター(終了時点)
        'issuer_shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 発行店舗ID
        'description' => "xEFE11voG",             // チャージQRコードの説明文
...
$request = new Request\CreateCheck(
    ...
    [
        'money_amount' => 301.0,                  // 付与マネー額
        'point_amount' => 4188.0,                 // 付与ポイント額
        'description' => "test check",            // 説明文(アプリ上で取引の説明文として表示される)
        'is_onetime' => FALSE,                    // ワンタイムかどうかのフラグ
        'usage_limit' => 8236,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2021-01-31T22:29:59.000000Z", // チャージQRコード自体の失効日時
        'point_expires_at' => "2022-10-28T11:37:53.000000Z", // チャージQRコードによって付与されるポイント残高の有効期限
...
$request = new Request\UpdateCheck(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // checkId: チャージQRコードのID
    [
        'money_amount' => 4136.0,                 // 付与マネー額
        'point_amount' => 6857.0,                 // 付与ポイント額
        'description' => "test check",            // チャージQRコードの説明文
        'is_onetime' => FALSE,                    // ワンタイムかどうかのフラグ
        'usage_limit' => 3052,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2020-12-15T17:24:57.000000Z", // チャージQRコード自体の失効日時
        'point_expires_at' => "2021-11-28T19:59:09.000000Z", // チャージQRコードによって付与されるポイント残高の有効期限
        'point_expires_in_days' => 60,            // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
        'bear_point_account' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // ポイント額を負担する店舗のウォレットID
