...
$request = new Request\ListChecks(
    [
        ...
        'organization_code' => "MxYByLz0xsJRhRVsB", // 組織コード
        'expires_from' => "2023-08-16T16:39:07.000000Z", // 有効期限の期間によるフィルター(開始時点)
        'expires_to' => "2020-11-02T03:49:28.000000Z", // 有効期限の期間によるフィルター(終了時点)
        'created_from' => "2020-05-16T18:29:14.000000Z", // 作成日時の期間によるフィルター(開始時点)
        'created_to' => "2023-05-06T00:13:31.000000Z", // 作成日時の期間によるフィルター(終了時点)
        'issuer_shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 発行店舗ID
        'description' => "fWzO75yHWR",            // チャージQRコードの説明文
...
$request = new Request\CreateCheck(
    ...
    [
        'money_amount' => 4828.0,                 // 付与マネー額
        'point_amount' => 2091.0,                 // 付与ポイント額
        'description' => "test check",            // 説明文(アプリ上で取引の説明文として表示される)
        'is_onetime' => TRUE,                     // ワンタイムかどうかのフラグ
        'usage_limit' => 8890,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2021-05-03T16:40:55.000000Z", // チャージQRコード自体の失効日時
        'point_expires_at' => "2024-02-14T06:16:14.000000Z", // チャージQRコードによって付与されるポイント残高の有効期限
...
$request = new Request\UpdateCheck(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // checkId: チャージQRコードのID
    [
        'money_amount' => 7631.0,                 // 付与マネー額
        'point_amount' => 1210.0,                 // 付与ポイント額
        'description' => "test check",            // チャージQRコードの説明文
        'is_onetime' => TRUE,                     // ワンタイムかどうかのフラグ
        'usage_limit' => 9871,                    // ワンタイムでない場合の最大読み取り回数
        'expires_at' => "2023-05-12T01:44:13.000000Z", // チャージQRコード自体の失効日時
        'point_expires_at' => "2020-12-02T01:05:53.000000Z", // チャージQRコードによって付与されるポイント残高の有効期限
        'point_expires_in_days' => 60,            // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
        'bear_point_account' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // ポイント額を負担する店舗のウォレットID
