...
## #<HEADING (N 2 TEXT ListOrganizations)>: 加盟店組織の一覧を取得する
...
## #<HEADING (N 2 TEXT CreateOrganization)>: 新規加盟店組織を追加する
...
$request = new Request\CreateOrganization(
    ...
    "r2jIuan84U@JDT9.com",                        // issuerAdminUserEmail: 発行体担当者メールアドレス
    "Kfa354idc7@T4cl.com",                        // memberAdminUserEmail: 新規組織担当者メールアドレス
    [
        'bank_name' => "XYZ銀行",                   // 銀行名
