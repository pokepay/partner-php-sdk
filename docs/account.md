...
$request = new Request\CreateUserAccount(
    ...
    [
        'name' => "ud9b5MHdM8UnuwQ7jNoaulXZjgrVDfW2ufNp0gAs9phyFh2aSmdruAKFNN9YCEWSULZdpylXeF6qv", // ウォレット名
        'external_id' => "GwUl7ATMaf3NqLOcKmTPNREiEdfOxl", // 外部ID
