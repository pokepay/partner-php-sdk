...
$request = new Request\GetPrivateMoneyOrganizationSummaries(
    ...
    [
        'from' => "2022-01-21T15:26:55.000000Z",  // 開始日時(toと同時に指定する必要有)
        'to' => "2023-01-28T00:22:50.000000Z",    // 終了日時(fromと同時に指定する必要有)
        'page' => 1,                              // ページ番号
...
$request = new Request\GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // privateMoneyId: マネーID
    [
        'from' => "2022-03-14T01:56:15.000000Z",  // 開始日時
        'to' => "2020-11-29T07:09:26.000000Z"     // 終了日時
    ]
);
```
