...
$request = new Request\GetPrivateMoneyOrganizationSummaries(
    ...
    [
        'from' => "2023-03-06T13:43:38.000000Z",  // 開始日時(toと同時に指定する必要有)
        'to' => "2024-12-29T02:10:18.000000Z",    // 終了日時(fromと同時に指定する必要有)
        'page' => 1,                              // ページ番号
...
$request = new Request\GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // privateMoneyId: マネーID
    [
        'from' => "2023-06-28T17:41:46.000000Z",  // 開始日時
        'to' => "2020-02-09T09:37:50.000000Z"     // 終了日時
    ]
);
```
