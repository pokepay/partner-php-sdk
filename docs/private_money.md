...
$request = new Request\GetPrivateMoneyOrganizationSummaries(
    ...
    [
        'from' => "2022-12-09T09:40:16.000000+09:00", // 開始日時(toと同時に指定する必要有)
        'to' => "2020-03-10T02:59:45.000000+09:00", // 終了日時(fromと同時に指定する必要有)
        'page' => 1,                              // ページ番号
...
$request = new Request\GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // privateMoneyId: マネーID
    [
        'from' => "2023-06-25T01:57:49.000000+09:00", // 開始日時
        'to' => "2021-08-02T03:06:20.000000+09:00" // 終了日時
    ]
);
```
