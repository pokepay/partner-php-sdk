...
$request = new Request\GetPrivateMoneyOrganizationSummaries(
    ...
    [
        'from' => "2024-08-29T19:52:43.000000+09:00", // 開始日時(toと同時に指定する必要有)
        'to' => "2020-10-29T08:43:56.000000+09:00", // 終了日時(fromと同時に指定する必要有)
        'page' => 1,                              // ページ番号
...
$request = new Request\GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // privateMoneyId: マネーID
    [
        'from' => "2024-09-06T12:53:47.000000+09:00", // 開始日時
        'to' => "2022-04-05T18:32:43.000000+09:00" // 終了日時
    ]
);
```
