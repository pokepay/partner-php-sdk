...
$request = new Request\ListBills(
    [
        'page' => 4453,                           // ページ番号
        'per_page' => 5033,                       // 1ページの表示数
        'bill_id' => "sFhn",                      // 支払いQRコードのID
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
        'organization_code' => "Aj0A6",           // 組織コード
        'description' => "test bill",             // 取引説明文
        'created_from' => "2021-09-29T09:58:14.000000Z", // 作成日時(起点)
        'created_to' => "2022-04-17T10:31:09.000000Z", // 作成日時(終点)
        'shop_name' => "bill test shop1",         // 店舗名
        'shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
        'lower_limit_amount' => 8508,             // 金額の範囲によるフィルタ(下限)
        'upper_limit_amount' => 5113,             // 金額の範囲によるフィルタ(上限)
