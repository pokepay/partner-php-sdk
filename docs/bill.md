...
$request = new Request\ListBills(
    [
        'page' => 5458,                           // ページ番号
        'per_page' => 5606,                       // 1ページの表示数
        'bill_id' => "v",                         // 支払いQRコードのID
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
        'organization_code' => "15-Q7o3l1g-veO--1sFdC3lq1H-", // 組織コード
        'description' => "test bill",             // 取引説明文
        'created_from' => "2020-05-16T11:51:07.000000Z", // 作成日時(起点)
        'created_to' => "2023-07-23T17:45:18.000000Z", // 作成日時(終点)
        'shop_name' => "bill test shop1",         // 店舗名
        'shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
        'lower_limit_amount' => 7226,             // 金額の範囲によるフィルタ(下限)
        'upper_limit_amount' => 9115,             // 金額の範囲によるフィルタ(上限)
