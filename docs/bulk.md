...
$request = new Request\BulkCreateTransaction(
    "EmVia7WMZwoONY",                             // name: 一括取引タスク名
    "mYcjUD3BWf",                                 // content: 取引する情報のCSV
    "N3hpObBbd0WPCuqh90wnUEefdvvGn56xgqcI",       // requestId: リクエストID
    [
        'description' => "C0MaOVTzOYUS4YiFzadS1dG4VhCAXdvLcusNkP92lEHAtBr5uMSg7mI2h9L5UgNjF9pGXPoR6V6EH9o", // 一括取引の説明
