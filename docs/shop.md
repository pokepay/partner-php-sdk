...
$request = new Request\ListShops(
    [
        ...
        'name' => "oxスーパー三田店",                    // 店舗名
        'postal_code' => "8753979",               // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "080-9185709",                   // 店舗の電話番号
        'email' => "W0eFslSf8N@aBTy.com",         // 店舗のメールアドレス
        'external_id' => "6GBT8tDHI0zWcr0sMpkdiHO", // 店舗の外部ID
...
$request = new Request\CreateShop(
    ...
    [
        'shop_postal_code' => "7945658",          // 店舗の郵便番号
        'shop_address' => "東京都港区芝...",            // 店舗の住所
        'shop_tel' => "049-1045366",              // 店舗の電話番号
        'shop_email' => "uFUQK5yc0J@qyEb.com",    // 店舗のメールアドレス
        'shop_external_id' => "k4xV1El",          // 店舗の外部ID
...
$request = new Request\CreateShopV2(
    "oxスーパー三田店",                                  // name: 店舗名
    [
        'postal_code' => "447-6076",              // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "03838158089",                   // 店舗の電話番号
        'email' => "qH3TntlxmP@Sv0s.com",         // 店舗のメールアドレス
        'external_id' => "MHVeJGZnQaE4lp3S7",     // 店舗の外部ID
        'organization_code' => "ox-supermarket",  // 組織コード
...
$request = new Request\UpdateShop(
    ...
    [
        'name' => "oxスーパー三田店",                    // 店舗名
        'postal_code' => "960-3097",              // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "00125168575",                   // 店舗の電話番号
        'email' => "q5OqWuTabd@RaaH.com",         // 店舗のメールアドレス
        'external_id' => "yfGqVUncXzhjskeG",      // 店舗の外部ID
