...
$request = new Request\ListShops(
    [
        ...
        'name' => "oxスーパー三田店",                    // 店舗名
        'postal_code' => "251-3121",              // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "072531334",                     // 店舗の電話番号
        'email' => "CVaIjvXY9b@uv1P.com",         // 店舗のメールアドレス
        'external_id' => "GDaqpxNAcB7XJ2PMH0HA7mMCxlziaJ", // 店舗の外部ID
...
$request = new Request\CreateShop(
    ...
    [
        'shop_postal_code' => "089-3949",         // 店舗の郵便番号
        'shop_address' => "東京都港区芝...",            // 店舗の住所
        'shop_tel' => "0760279520",               // 店舗の電話番号
        'shop_email' => "5BIbPwZWpt@KeWM.com",    // 店舗のメールアドレス
        'shop_external_id' => "AfjTzhjO10bQwyTU6ZUhrOp80a47LYIcD57", // 店舗の外部ID
...
$request = new Request\CreateShopV2(
    "oxスーパー三田店",                                  // name: 店舗名
    [
        'postal_code' => "988-9497",              // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "011-4139-0843",                 // 店舗の電話番号
        'email' => "hYuqMOfry8@huKL.com",         // 店舗のメールアドレス
        'external_id' => "aun9q8fRCMt2pzYekawpUou", // 店舗の外部ID
        'organization_code' => "ox-supermarket",  // 組織コード
...
$request = new Request\UpdateShop(
    ...
    [
        'name' => "oxスーパー三田店",                    // 店舗名
        'postal_code' => "6598642",               // 店舗の郵便番号
        'address' => "東京都港区芝...",                 // 店舗の住所
        'tel' => "007506377",                     // 店舗の電話番号
        'email' => "fEngR6pF3m@54Vm.com",         // 店舗のメールアドレス
        'external_id' => "wYrg",                  // 店舗の外部ID
