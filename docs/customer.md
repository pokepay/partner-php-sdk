...
$request = new Request\ListAccountBalances(
    ...
    [
        'page' => 3336,                           // ページ番号
        'per_page' => 3608,                       // 1ページ分の取引数
        'expires_at_from' => "2024-05-31T17:53:22.000000Z", // 有効期限の期間によるフィルター(開始時点)
        'expires_at_to' => "2020-05-25T03:33:29.000000Z", // 有効期限の期間によるフィルター(終了時点)
...
$request = new Request\ListAccountExpiredBalances(
    ...
    [
        'page' => 109,                            // ページ番号
        'per_page' => 9807,                       // 1ページ分の取引数
        'expires_at_from' => "2022-08-16T16:09:33.000000Z", // 有効期限の期間によるフィルター(開始時点)
        'expires_at_to' => "2022-08-11T11:18:34.000000Z", // 有効期限の期間によるフィルター(終了時点)
        'direction' => "asc"                      // 有効期限によるソート順序
    ]
);
```
...
$request = new Request\UpdateCustomerAccount(
    ...
    [
        'status' => "suspended",                  // ウォレット状態
        'account_name' => "pOFZAAuAkdYYYV8q02r77ePIgPu4dPH7ImSF7bIQ97lNoNEqqi11P4GN23Eb6NlDd7BTwpYu4Valw5xiIJ7Q1Cipp2CPMRifbrHbdPk0z0U5np6zSSSsJChBCfGVrTTzFEA3cEkuniAENmbJtM74yoK3yNaovdjb7urlPondGWEfVzKM", // アカウント名
        'external_id' => "w",                     // 外部ID
...
$request = new Request\GetCustomerAccounts(
    ...
    [
        'page' => 6209,                           // ページ番号
        'per_page' => 617,                        // 1ページ分のウォレット数
        'created_at_from' => "2020-08-18T23:12:40.000000Z", // ウォレット作成日によるフィルター(開始時点)
        'created_at_to' => "2020-01-21T15:44:21.000000Z", // ウォレット作成日によるフィルター(終了時点)
        'is_suspended' => FALSE,                  // ウォレットが凍結状態かどうかでフィルターする
        'status' => "pre-closed",                 // ウォレット状態
        'external_id' => "ATPnnGfbSAjt8y1LpRX9w3aEMSDM7H6DKpMVCMs6AqP", // 外部ID
        'tel' => "0014-7998938",                  // エンドユーザーの電話番号
        'email' => "1yqyLKdrb7@VdvB.com"          // エンドユーザーのメールアドレス
    ]
);
```
...
$request = new Request\CreateCustomerAccount(
    ...
    [
        ...
        'external_id' => "errdPPsgFTBp21GVpuNthlN8cTNxtClPPAh3ydu" // 外部ID
    ]
);
```
...
$request = new Request\GetShopAccounts(
    ...
    [
        'page' => 8201,                           // ページ番号
        'per_page' => 4004,                       // 1ページ分のウォレット数
        'created_at_from' => "2020-06-04T04:22:02.000000Z", // ウォレット作成日によるフィルター(開始時点)
        'created_at_to' => "2023-02-26T22:06:45.000000Z", // ウォレット作成日によるフィルター(終了時点)
        'is_suspended' => FALSE                   // ウォレットが凍結状態かどうかでフィルターする
    ]
);
```
...
$request = new Request\ListCustomerTransactions(
    ...
    [
        ...
        'from' => "2021-05-20T19:34:04.000000Z",  // 開始日時
        'to' => "2021-03-28T11:51:41.000000Z",    // 終了日時
        'page' => 1,                              // ページ番号
