...
$request = new Request\ListTransactions(
    [
        'from' => "2021-11-26T04:55:53.000000+09:00", // 開始日時
        'to' => "2023-06-09T07:58:48.000000+09:00", // 終了日時
        'page' => 1,                              // ページ番号
...
$request = new Request\CreateTransaction(
    ...
    [
        'money_amount' => 3366,
        'point_amount' => 2697,
        'point_expires_at' => "2023-09-01T04:08:17.000000+09:00", // ポイント有効期限
...
$request = new Request\ListTransactionsV2(
    [
        ...
        'types' => ["topup", "payment"],          // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
        'from' => "2020-09-01T04:44:16.000000+09:00", // 開始日時
        'to' => "2023-10-04T11:25:11.000000+09:00", // 終了日時
...
$request = new Request\CreateTopupTransaction(
    ...
    [
        ...
        'point_expires_at' => "2024-07-14T06:45:38.000000+09:00", // ポイント有効期限
...
$request = new Request\RefundTransaction(
    ...
    [
        ...
        'returning_point_expires_at' => "2020-07-18T08:24:12.000000+09:00" // 返却ポイントの有効期限
    ]
);
```
