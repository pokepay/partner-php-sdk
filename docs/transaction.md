...
$request = new Request\GetCpmToken(
    "VlOR0ZjHbJ4pIYeH1mIjK9"                      // cpmToken: CPMトークン
);
```
...
$request = new Request\ListTransactions(
    [
        'from' => "2022-07-13T05:35:45.000000Z",  // 開始日時
        'to' => "2020-04-01T22:11:46.000000Z",    // 終了日時
        'page' => 1,                              // ページ番号
...
$request = new Request\CreateTransaction(
    ...
    [
        'money_amount' => 9407,
        'point_amount' => 3047,
        'point_expires_at' => "2021-08-24T12:27:37.000000Z", // ポイント有効期限
        'description' => "xEgMUhIRyB0Lq7z8Ljil9JSMA7rA7mkLLtmKf"
    ]
);
```
...
$request = new Request\ListTransactionsV2(
    [
        ...
        'customer_name' => "太郎",                  // エンドユーザー名
        'description' => "店頭QRコードによる支払い",         // 取引説明文
        'transaction_id' => "guDK",               // 取引ID
        'is_modified' => FALSE,                   // キャンセルフラグ
        'types' => ["topup", "payment"],          // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
        'from' => "2022-01-28T04:25:03.000000Z",  // 開始日時
        'to' => "2020-02-02T04:29:50.000000Z",    // 終了日時
...
$request = new Request\ListBillTransactions(
    [
        ...
        'is_modified' => FALSE,                   // キャンセルフラグ
        'from' => "2020-08-25T15:58:22.000000Z",  // 開始日時
        'to' => "2020-10-03T21:50:55.000000Z",    // 終了日時
        'next_page_cursor_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 次ページへ遷移する際に起点となるtransactionのID
        'prev_page_cursor_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 前ページへ遷移する際に起点となるtransactionのID
        'per_page' => 50                          // 1ページ分の取引数
    ]
...
$request = new Request\CreateTopupTransaction(
    ...
    [
        ...
        'money_amount' => 4700,                   // マネー額
        'point_amount' => 127,                    // ポイント額
        'point_expires_at' => "2024-10-07T22:21:27.000000Z", // ポイント有効期限
...
$request = new Request\CreateCpmTransaction(
    "jODYIDOJbPEulQIvNSkQAL",                     // cpmToken: CPMトークン
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // shopId: 店舗ID
    1573.0,                                       // amount: 取引金額
    [
...
$request = new Request\CreateExchangeTransaction(
    ...
    9589,
    [
        'description' => "pQNr6y6a28m0nRuldHpSuEUpdPie9qQ2GFfC0at9jn8DwInc5YWbNc2E2NkkIcBn5byBGxSlhAbqrppUqGdxMolEMce2oIWkzh6xh3kO5wXHuEli1NcEVyTrb",
        'request_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" // リクエストID
    ]
);
```
...
$request = new Request\RefundTransaction(
    ...
    [
        ...
        'returning_point_expires_at' => "2025-02-20T02:00:14.000000Z" // 返却ポイントの有効期限
    ]
);
```
