...
$request = new Request\GetAccountTransferSummary(
    ...
    [
        'from' => "2021-04-11T12:55:41.000000Z",  // 集計期間の開始時刻
        'to' => "2021-03-20T17:33:12.000000Z",    // 集計期間の終了時刻
...
$request = new Request\ListTransfers(
    [
        'from' => "2023-07-26T06:27:00.000000Z",
        'to' => "2023-05-17T11:08:47.000000Z",
        'page' => 8765,
        'per_page' => 7913,
        'shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'shop_name' => "b0Gko8iE0P3Cu0AOaTlKzyVFYYoK00acoGlEqYYGWZUMgU5LJ8ned",
        'customer_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'customer_name' => "bEkL6VCbZlYCZFu0YjXrvick1kbCzvMElblaTUs",
        'transaction_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'is_modified' => FALSE,
        'transaction_types' => ["topup"],
        'transfer_types' => ["cashback", "expire", "topup", "coupon"], // 取引明細の種類でフィルターします。
...
$request = new Request\ListTransfersV2(
    [
        ...
        'shop_name' => "yFdijXYZ6Fkp0v2rObj5KP7CaX5R9O7hnOQMfDj4u8or1Z5ajnFBytvfCWU5lvasIan6Df8qsq2k3ETquM3SQujWFDE153B47G8gAIFr9zY1ABG4Q6S1AZ81ee9F1zaeUGprRtPpZgZzOhvmvIjVKe7aM7QiN4LuTtB8ZF5mN9clYyKl8cUsYw8CW8rHVcmWZsjKlFT0f7did2pSfVDNNjekhaUaqNZOry7pQcwkQvvHfTZTUiaSBniTvgiFcfF", // 店舗名
        'customer_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // エンドユーザーID
        'customer_name' => "WfXoobW27D2zSsjxSJQCC2TKE3m70u0i2E7e3WCog3HknLhb4mGHjaX24jJAlJFQ82MhyQQoipgFNSux0jeobdQD1VXjUggH7qMtHhSfZdXUyjb1NxKa8yAWf3eI4rn2GKxT8MfsHveV88627AlMJYf8MI0c", // エンドユーザー名
        'transaction_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 取引ID
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
        'is_modified' => TRUE,                    // キャンセルフラグ
        'transaction_types' => ["payment", "transfer", "topup", "cashback"], // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
        ...
        'transfer_types' => ["topup", "cashback", "campaign"], // 取引明細種別 (複数指定可)
        'description' => "店頭QRコードによる支払い",         // 取引詳細説明文
        'from' => "2020-05-19T07:59:46.000000Z",  // 開始日時
        'to' => "2020-02-21T12:15:42.000000Z"     // 終了日時
    ]
);
```
