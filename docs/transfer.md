...
$request = new Request\GetAccountTransferSummary(
    ...
    [
        'from' => "2022-05-05T16:07:09.000000+09:00", // 集計期間の開始時刻
        'to' => "2021-02-20T11:21:59.000000+09:00", // 集計期間の終了時刻
...
$request = new Request\ListTransfers(
    [
        'from' => "2020-08-22T11:03:17.000000+09:00",
        'to' => "2023-12-11T01:06:47.000000+09:00",
        'page' => 4181,
        'per_page' => 7358,
        'shop_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'shop_name' => "abdRaaHOyfGqVUncXzh",
        'customer_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'customer_name' => "jskeGyZxmbEy050Zlv3tzVr8aTPDqMKbxS0Vs3OlIrdnx7rU9Fte9Z959oBy13mtel3d8TfJ3Ol39ScasZnA58jo0hnztlMdM7BVfn4iFYyJJXfrDUn2Z5dTBMhYMOaLFSQqsldJH",
        'transaction_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        'is_modified' => FALSE,
        'transaction_types' => ["payment", "expire", "topup", "transfer", "exchange"],
        'transfer_types' => ["coupon", "campaign", "transfer", "topup", "payment", "exchange", "cashback"], // 取引明細の種類でフィルターします。
...
$request = new Request\ListTransfersV2(
    [
        ...
        'shop_name' => "pZ7fJl29A3O6y0fQnXOgwkIth5yMWiTVYzb9YasuIp7v4EzACicWq4Ul0bBBFnJwjrPufrwL5Z4qM5cyeftMbZhJuNsCdqVbAgLZ", // 店舗名
        'customer_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // エンドユーザーID
        'customer_name' => "KQXblhvdQVC38rMOaKHSf5htPpycWdWsbduWBxtfg1Kliu47KITpvwbo61t0xPHohZAfXS5WAq97VI0kJjyO9S00lRKqhRSKyv4aeUNiX5kIXisF2lvLdWFAH9CECfmZyvOgcw2bcIoYI3B409EBsOM5mHn7CA1SM3xNEFCgQheyCbSnP7P0SqnjQBF0gNpyvaBHzjlAdXU9fbl4BE", // エンドユーザー名
        'transaction_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 取引ID
        'private_money_id' => "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
        'is_modified' => TRUE,                    // キャンセルフラグ
        'transaction_types' => ["expire", "transfer", "cashback", "topup"], // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
        ...
        'transfer_types' => ["coupon", "campaign"], // 取引明細種別 (複数指定可)
        'description' => "店頭QRコードによる支払い",         // 取引詳細説明文
        'from' => "2025-01-23T13:09:44.000000+09:00", // 開始日時
        'to' => "2020-04-10T21:40:34.000000+09:00" // 終了日時
    ]
);
```
