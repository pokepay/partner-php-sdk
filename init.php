...
require dirname(__FILE__) . '/lib/Request/CreateShop.php';
...
require dirname(__FILE__) . '/lib/Response/User.php';
require dirname(__FILE__) . '/lib/Response/Account.php';
...
require dirname(__FILE__) . '/lib/Response/PrivateMoney.php';
